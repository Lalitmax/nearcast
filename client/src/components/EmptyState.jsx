...
export default function EmptyState({ filterZipcode, showNearby }) {
  return (
    <div className="text-center py-16 bg-white dark:bg-card-dark rounded-2xl shadow-xl border border-border dark:border-border-dark animate-[fadeIn_0.5s_ease-out]">
      ...
      <p className="text-text-light dark:text-text-light-dark mb-6 max-w-md mx-auto">
        {showNearby
          ? "No posts found in nearby zipcodes. Be the first to share something with your neighbors!"
          : `No posts found in zipcode ${filterZipcode}. Be the first to share something with your neighbors!`}
      </p>
